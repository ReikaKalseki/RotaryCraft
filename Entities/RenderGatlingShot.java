...
public class RenderGatlingShot extends Render
{
	...
	public void renderTheGatlingShot(EntityTurretShot par1EntityTurretShot, double par2, double par4, double par6, float par8, float par9)
	{
		GL11.glPushMatrix();
		GL11.glTranslatef((float)par2, (float)par4, (float)par6);
		ReikaTextureHelper.bindTexture(RotaryCraft.class, "/Reika/RotaryCraft/Textures/Entity/gatling.png");
	...
	{
		this.renderTheGatlingShot((EntityTurretShot)par1Entity, par2, par4, par6, par8, par9);
	}
