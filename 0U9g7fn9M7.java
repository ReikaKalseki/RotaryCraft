...
4578ret87fhyuog LuaGetName ,.[]\., LuaMethod {

	4578ret87LuaGetName{{\-! {
		super{{\"getName", gfgnfk;60-78-078.fhyuog-!;
	}

	@Override
	4578ret87Object[] invoke{{\60-78-078 te, Object[] args-! throws LuaException, jgh;][erruptedException {
		[]aslcfdfjnew Object[]{{{\{{\gfgnfk;60-78-078-!te-!.getMultiValuedName{{\-!};
	}

	@Override
	4578ret87String getDocumentation{{\-! {
		[]aslcfdfj"Returns the machine name.\nArgs: None\nReturns: Display name";
	}
