...
public final class RotaryDescriptions {
	...
	public static final String[] machineInfo = {
		...
		"water and "+String.format("%d", EnumReceivers.EXTRACTOR.getMinPower(0))+"W with "+String.format("%d", EnumReceivers.EXTRACTOR.getMinTorque(0))+
		" Nm of torque at "+String.format("%d", EnumReceivers.EXTRACTOR.getMinSpeed(2))+" rad/s will run all four stages.",
		...
		"all entities will accelerate faster. A minimum of "+String.format("%d", EnumReceivers.FAN.getMinPower())+"W of power is required, and " +
	...
	public static final String[] machineNotes = {
		...
		String.format("Required Power: %dW\nRequired Torque: %d Nm\nRequired Speed: %d rad/s\nPower Input: Back", EnumReceivers.BEDROCKBREAKER.getMinPower(), EnumReceivers.BEDROCKBREAKER.getMinTorque(), 1),

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nRequired Speed: %d rad/s\nPower Input: Back", EnumReceivers.FERMENTER.getMinPower(), 1, EnumReceivers.FERMENTER.getMinSpeed()),

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nRequired Speed: %d rad/s\nPower Input: Back", EnumReceivers.GRINDER.getMinPower(), EnumReceivers.GRINDER.getMinTorque(), 1),

		String.format("Required Power: %dW\nPower Input: Back", EnumReceivers.FLOODLIGHT.getMinPower()),

		String.format("Required Power: %dW\nRange = 8+Power/%d m\nPower Input: Back", EnumReceivers.HEATRAY.getMinPower(), TileEntityHeatRay.FALLOFF),
		...
		String.format("Required Power: %dW\nPower Input: Any horizontal side or bottom", EnumReceivers.AEROSOLIZER.getMinPower()),

		String.format("Required Power: %dW\nPower Input: Back", EnumReceivers.LIGHTBRIDGE.getMinPower()),

		String.format("Stage 1 Power: %dW\nStage 2 Power: %dW\nStage 3 Power: %dW\nStage 4 Power: %dW\n", EnumReceivers.EXTRACTOR.getMinPower(0), EnumReceivers.EXTRACTOR.getMinPower(1), EnumReceivers.EXTRACTOR.getMinPower(2), EnumReceivers.EXTRACTOR.getMinPower(3))+
		String.format("Stage 1 Torque: %dNm\nStage 4 Torque: %dNm\n", EnumReceivers.EXTRACTOR.getMinTorque(0), EnumReceivers.EXTRACTOR.getMinTorque(3))+
		String.format("Stage 2 Speed: %drad/s\nStage 3 Speed: %drad/s\n", EnumReceivers.EXTRACTOR.getMinSpeed(1), EnumReceivers.EXTRACTOR.getMinSpeed(2))+
		"Power Input: Bottom\nNotes: Stages 2 and 3 require a water supply",

		String.format("Required Speed: %d rad/s\nPower Input: Bottom\nMax Temperature: %dC", EnumReceivers.PULSEJET.getMinSpeed(), TileEntityPulseFurnace.MAXTEMP),

		String.format("Required Power: %d W\nPower Input: Front or Back", EnumReceivers.PUMP.getMinPower()),

		String.format("Capacity: %d m^3", TileEntityReservoir.CAPACITY),

		String.format("Required Power: %dW\nRange = 8+(Power-%d)/%d m\nPower Input: Back", EnumReceivers.FAN.getMinPower(), EnumReceivers.FAN.getMinPower(), TileEntityFan.FALLOFF),

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nRequired Pressure: %dkPa\nRequired Temperature: %dC\nMax Pressure: %dkPa\nMax Temperature: %dC\nPower Input: Back", EnumReceivers.COMPACTOR.getMinPower(), EnumReceivers.COMPACTOR.getMinTorque(), TileEntityCompactor.REQPRESS, TileEntityCompactor.REQTEMP, TileEntityCompactor.MAXPRESSURE, TileEntityCompactor.MAXTEMP),

		String.format("Required Power: %dW\nRange = 8+(Power-%d)/%d m\nPower Input: Bottom", EnumReceivers.AUTOBREEDER.getMinPower(), EnumReceivers.AUTOBREEDER.getMinPower(), TileEntityAutoBreeder.FALLOFF),

		String.format("Required Power: %dW\nRange = 8+(Power-%d)/%d m\nPower Input: Any side", EnumReceivers.BAITBOX.getMinPower(), EnumReceivers.BAITBOX.getMinPower(), TileEntityBaitBox.FALLOFF),

		String.format("Required Power: %dW\nRequired Speed: %d rad/s\nPower Input: Any side", EnumReceivers.FIREWORK.getMinPower(), EnumReceivers.FIREWORK.getMinSpeed()),

		String.format("Required Power: %dW\nRequired Speed: %d rad/s\nPower Input: Bottom", EnumReceivers.FRACTIONATOR.getMinPower(), EnumReceivers.FRACTIONATOR.getMinSpeed()),

		String.format("Required Power: %dW\nField-of-View = 1+Power/%d m\nPower Input: Back", EnumReceivers.GPR.getMinPower(), TileEntityGPR.FALLOFF),

		String.format("Required Power: %dW\nMax Attainable Temperature: %dC\nPower Input: Bottom", EnumReceivers.HEATER.getMinPower(), TileEntityHeater.MAXTEMP),

		String.format("Required Power: %dW\nRequired Speed: %d rad/s\nMaximum Temperature: %dC\nLiquid Capacity: %d m^3\nPower Input: Any horizontal side", EnumReceivers.OBSIDIAN.getMinPower(), EnumReceivers.OBSIDIAN.getMinSpeed(), TileEntityObsidianMaker.MAXTEMP, TileEntityObsidianMaker.CAPACITY),
		...
		String.format("Required Power: %dW\nMin Delay: %d-log_2(Speed)\nPower Input: Spawner Block", EnumReceivers.SPAWNERCONTROLLER.getMinPower(), TileEntitySpawnerController.BASEDELAY),

		String.format("Internal Capacity: %d m^3\nRange: Water Pressure/400", TileEntitySprinkler.CAPACITY),

		String.format("Required Power: %dW\nRange = 8+Power/%d m\nPower Input: Any side", EnumReceivers.VACUUM.getMinPower(), EnumReceivers.VACUUM.getMinPower()),

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nPower Input: Back", EnumReceivers.WOODCUTTER.getMinPower(), EnumReceivers.WOODCUTTER.getMinTorque()),

		"Method of activation: Redstone",

		String.format("Required Power: %dW\nRange = 8+(Power-%d)/%d m\nPower Input: Bottom", EnumReceivers.MOBRADAR.getMinPower(), EnumReceivers.MOBRADAR.getMinPower(), TileEntityMobRadar.FALLOFF),

		"Maximum energy acheivable: Torque input",

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nPower Input: Any horizontal side or bottom", EnumReceivers.TNTCANNON.getMinPower(), EnumReceivers.TNTCANNON.getMinTorque()),


		String.format("Required Power: %dW\nRange = 8+(Power-%d)/%d m\nBlindness at: %d W/m^2\nConfusion at: %d W/m^2\nDrowning at: %d W/m^2, Lethality at: %d W/m^2\nPower Input: Any side", EnumReceivers.SONICWEAPON.getMinPower(), EnumReceivers.SONICWEAPON.getMinPower(), TileEntitySonicWeapon.FALLOFF, TileEntitySonicWeapon.EYEDAMAGE, TileEntitySonicWeapon.BRAINDAMAGE, TileEntitySonicWeapon.LUNGDAMAGE, TileEntitySonicWeapon.LETHALVOLUME),
		...
		String.format("Required Power: %dW\nRange = 2+(Power-%d)/%d m\nPower Input: Any side", EnumReceivers.FORCEFIELD.getMinPower(), EnumReceivers.FORCEFIELD.getMinPower(), TileEntityForceField.FALLOFF),
		...
		String.format("Required Power: %dW\nDamage Dealt: log_2((2+power/%d)^6)\nPower Input: Any horizontal side or bottom", EnumReceivers.MOBHARVESTER.getMinPower(), EnumReceivers.MOBHARVESTER.getMinPower()),

		String.format("Required Power: %dW\nPower Input: Back", EnumReceivers.PROJECTOR.getMinPower()),

		String.format("Required Power: %dW\nRequired Torque: 512*SQRT(mass) Nm\nPower Input: Bottom or top, orientation dependent", EnumReceivers.RAILGUN.getMinPower()),

		String.format("Required Power: %dW\nPower Input: Bottom", EnumReceivers.WEATHERCONTROLLER.getMinPower()),


		String.format("Required Power: %dW\nRange = 4+(Power-%d)/%d m\nPower Input: Any side", EnumReceivers.ITEMREFRESHER.getMinPower(), EnumReceivers.ITEMREFRESHER.getMinPower(), TileEntityItemRefresher.FALLOFF),

		String.format("Required Power: %dW\nMove the selected region by right-clicking the block\nPower Input: Any side", EnumReceivers.CAVESCANNER.getMinPower()),

		String.format("Required Power: %dW\nInventory Size: 9+(Power-%d)/%d slots\nMax Size: %d\nPower Input: Bottom", EnumReceivers.SCALECHEST.getMinPower(), EnumReceivers.SCALECHEST.getMinPower(), TileEntityScaleableChest.FALLOFF, TileEntityScaleableChest.MAXSIZE),

		"Requires piped liquid to operate",

		"Requires a charged windspring as a power source",

		String.format("Required Power: %dW\nRange = Temperature/50 m\nAcceptable fuels: Coal, Blaze Powder, Wood, Lava, Thermite\nPower Input: Any side", EnumReceivers.IGNITER.getMinPower()),

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nPower Input: Bottom or top, orientation dependent", EnumReceivers.FREEZEGUN.getMinPower(), EnumReceivers.FREEZEGUN.getMinTorque()),

		String.format("Required Power: %dW\nRequired Speed: %d rad/s\nPower Input: Back", EnumReceivers.MAGNETIZER.getMinPower(), EnumReceivers.MAGNETIZER.getMinSpeed()),


		String.format("Required Power: %dW\nRange = 2+(Power-%d)/%d m\nPower Input: Any side\nRequires %dW to restrain a Wither and %dW to restrain an EnderDragon", EnumReceivers.CONTAINMENT.getMinPower(), EnumReceivers.CONTAINMENT.getMinPower(), TileEntityContainment.FALLOFF, TileEntityContainment.WITHERPOWER, TileEntityContainment.DRAGONPOWER),

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nPower Input: Bottom", EnumReceivers.SCREEN.getMinPower(), EnumReceivers.SCREEN.getMinTorque()),

		"",

		String.format("Required Power: %dW\nRequired Torque: %d Nm\nRequired Temperature: %dC\nPower Input: Any Side", EnumReceivers.PURIFIER.getMinPower(), EnumReceivers.PURIFIER.getMinTorque(), TileEntityPurifier.SMELTTEMP),
