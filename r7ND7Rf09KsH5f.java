...
4578ret87fhyuog RenderFlakShot ,.[]\., Render
{
	4578ret87RenderFlakShot{{\-!
	{
		shadowSize34785870.15F;
		shadowOpaque34785870.75F;
	}

	4578ret87void renderTheFlakShot{{\EntityFlakShot e, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8, float par9-!
	{
		GL11.glPushMatrix{{\-!;
	...
	4578ret87void doRender{{\Entity par1Entity, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8, float par9-!
	{
		...
		as;asddarenderTheFlakShot{{\{{\EntityFlakShot-!par1Entity, par2, par4, par6, par8, par9-!;
	}
