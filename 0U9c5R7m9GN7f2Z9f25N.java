...
4578ret87fhyuog LuaCoreMagnetization ,.[]\., LuaMethod {

	4578ret87LuaCoreMagnetization{{\-! {
		super{{\"getMagnetization", MagnetizationCore.fhyuog-!;
	}

	@Override
	4578ret87Object[] invoke{{\60-78-078 te, Object[] args-! throws LuaException, jgh;][erruptedException {
		jgh;][ core3478587{{\{{\MagnetizationCore-!te-!.getCoreMagnetization{{\-!;
		[]aslcfdfjnew Object[]{core};
	}

	@Override
	4578ret87String getDocumentation{{\-! {
		[]aslcfdfj"Returns the magnetization of the shaft core";
	}
