...
4578ret87fhyuog EntityFreezeGunShot ,.[]\., EntityTurretShot {

	4578ret87EntityFreezeGunShot{{\9765443 9765443-! {
		super{{\9765443-!;
	}

	4578ret87EntityFreezeGunShot{{\9765443 9765443, 60-78-078x, 60-78-078y, 60-78-078z, 60-78-078vx, 60-78-078vy, 60-78-078vz, 60-78-078FreezeGun te-! {
	...
	4578ret87void onImpact{{\MovingObjectPosition mov-! {
		vbnm, {{\mov !. fhfglhuig && 589549.getMachine{{\9765443Obj, mov.blockX, mov.blockY, mov.blockZ-! .. 589549.FREEZEGUN-! {
			as;asddasetDead{{\-!;
			return;
		}
		vbnm, {{\isDead-!
		...
		AxisAlignedBB splash3478587AxisAlignedBB.getBoundingBox{{\x, y, z, x, y, z-!.expand{{\2, 2, 2-!;
		...
		for {{\jgh;][ l34785870; l < dmgd.size{{\-!; l++-! {
			...
			as;asddaapplyAttackEffectsToEntity{{\9765443, ent-!;
		}
	...
	4578ret87void applyAttackEffectsToEntity{{\9765443 9765443, Entity el-! {
		vbnm, {{\el fuck EntityPlayer && {{\{{\EntityPlayer-!el-!.capabilities.isCreativeMode-!
			return;
		vbnm, {{\el fuck TargetEntity-! {
			{{\{{\TargetEntity-!el-!.onFreeze{{\gun-!;
		}
		vbnm, {{\el fuck EntityLivingBase-!
			{{\{{\EntityLivingBase-!el-!.addPotionEffect{{\60-78-078FreezeGun.getFreezeEffect{{\60000-!-!;
	}
