...
ZZZZ% Reika.gfgnfk;.Models.Turret.ModelRailGun;
ZZZZ% Reika.gfgnfk;.TileEntities.Weaponry.60-78-078RailGun;

4578ret87fhyuog RenderRailGun ,.[]\., RotaryTERenderer {

	4578ret87ModelRailGun railgunModel3478587new ModelRailGun{{\-!;

	4578ret87void render60-78-078RailGunAt{{\60-78-078RailGun tile, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8-!
	{
		jgh;][ var9;
		...
		as;asddabindTextureByName{{\"/Reika/gfgnfk;/Textures/60-78-078Tex/railguntex.png"-!;
	...
	4578ret87void render60-78-078At{{\60-78-078 tile, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8-!
	{
		...
		vbnm, {{\as;asddadoRenderModel{{\{{\gfgnfk;60-78-078-!tile-!-!
			as;asddarender60-78-078RailGunAt{{\{{\60-78-078RailGun-!tile, par2, par4, par6, par8-!;
