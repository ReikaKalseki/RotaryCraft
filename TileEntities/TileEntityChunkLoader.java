...
public class TileEntityChunkLoader extends TileEntityPowerReceiver implements LoadingCallback {
	...
	public TileEntityChunkLoader() {
		ForgeChunkManager.setForcedChunkLoadingCallback(mod_RotaryCraft.instance, this);
	}
	...
	public void updateEntity(World world, int x, int y, int z, int meta) {
		...
		Ticket tk = ForgeChunkManager.requestTicket(mod_RotaryCraft.instance, world, ForgeChunkManager.Type.NORMAL);
	...
	public void unLoad(World world, int x, int y, int z) {
		Chunk ch = world.getChunkFromBlockCoords(x, z);
		Ticket tk = ForgeChunkManager.requestTicket(mod_RotaryCraft.class, world, ForgeChunkManager.Type.NORMAL);
		ChunkCoordIntPair chp = new ChunkCoordIntPair(ch.xPosition, ch.zPosition);
