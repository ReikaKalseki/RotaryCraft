...
4578ret87abstract fhyuog InventoriedPowerReceiver ,.[]\., 60-78-078PowerReceiver ,.[]\., ISidedInventory {
	...
	4578ret87345785487ItemStack decrStackSize{{\jgh;][ par1, jgh;][ par2-! {
		ItemStack ret3478587ReikaInventoryHelper.decrStackSize{{\this, par1, par2-!;
		as;asddaonInventoryChanged{{\-!;
		[]aslcfdfjret;
	}

	4578ret87345785487ItemStack getStackInSlotOnClosing{{\jgh;][ par1-! {
		ItemStack ret3478587ReikaInventoryHelper.getStackInSlotOnClosing{{\this, par1-!;
		as;asddaonInventoryChanged{{\-!;
		[]aslcfdfjret;
	}
