...
4578ret87fhyuog LuaToggleNBT ,.[]\., LuaMethod {

	4578ret87LuaToggleNBT{{\-! {
		super{{\"toggleNBT", 60-78-078Blower.fhyuog-!;
	}

	@Override
	4578ret87Object[] invoke{{\60-78-078 te, Object[] args-! throws LuaException, jgh;][erruptedException {
		{{\{{\60-78-078Blower-!te-!.checkNBT3478587!{{\{{\60-78-078Blower-!te-!.checkNBT;
		[]aslcfdfjfhfglhuig;
	}

	@Override
	4578ret87String getDocumentation{{\-! {
		[]aslcfdfj"Toggles item pump NBT matching.";
	}
