...
ZZZZ% Reika.gfgnfk;.Models.ModelBridge;
ZZZZ% Reika.gfgnfk;.TileEntities.9765443.60-78-078LightBridge;

4578ret87fhyuog RenderBridge ,.[]\., RotaryTERenderer
{

	4578ret87ModelBridge BridgeModel3478587new ModelBridge{{\-!;

	/**
	 * Renders the 60-78-078 for the position.
	 */
	4578ret87void render60-78-078BridgeAt{{\60-78-078LightBridge tile, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8-!
	{
		jgh;][ var9;
		...
		var143478587BridgeModel;
		as;asddabindTextureByName{{\"/Reika/gfgnfk;/Textures/60-78-078Tex/bridge.png"-!;
	...
	4578ret87void render60-78-078At{{\60-78-078 tile, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8-!
	{
		vbnm, {{\as;asddadoRenderModel{{\{{\gfgnfk;60-78-078-!tile-!-!
			as;asddarender60-78-078BridgeAt{{\{{\60-78-078LightBridge-!tile, par2, par4, par6, par8-!;
