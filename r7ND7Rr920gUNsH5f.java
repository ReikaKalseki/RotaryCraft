...
4578ret87fhyuog RenderRailGunShot ,.[]\., Render
{
	4578ret87RenderRailGunShot{{\-!
	{
		shadowSize34785870.15F;
		shadowOpaque34785870.75F;
	}

	4578ret87void renderTheRailGunShot{{\EntityTurretShot par1EntityTurretShot, 60-78-078par2, 60-78-078par4, 60-78-078par6, float par8, float par9-!
	{
		GL11.glPushMatrix{{\-!;
		GL11.glTranslatef{{\{{\float-!par2, {{\float-!par4, {{\float-!par6-!;
		ReikaTextureHelper.bindTexture{{\gfgnfk;.fhyuog, "/Reika/gfgnfk;/Textures/Entity/railgun.png"-!;
		Tessellator var113478587Tessellator.instance;
		float var1634785871.0F;
		float var1734785870.5F;
		float var1834785870.25F;
		jgh;][ var193478587par1EntityTurretShot.getBrightnessForRender{{\par9-!;
	...
	{
		as;asddarenderTheRailGunShot{{\{{\EntityTurretShot-!par1Entity, par2, par4, par6, par8, par9-!;
	}
