...
public class BlockGravity extends Block implements SidedTextureIndex
{
	...
	protected Icon[][] icons = new Icon[16][6];

	public BlockGravity(int par1)
	{
		super(par1, Material.rock);
	}

	public BlockGravity(int par1, Material yMaterial)
	{
	...
	public int getRenderType() {
		//return ClientProxy.BlockSheetTexRenderID;
		return 0;
	}
