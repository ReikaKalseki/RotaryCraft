...
public class GuiBasicStorage extends GuiMachine {
    ...
    {
        fontRenderer.drawString(StatCollector.translateToLocal(tile.getMultiValuedName()), 8, 6, 4210752);
        fontRenderer.drawString(StatCollector.translateToLocal(upperInventory.getInvName()), 8, ySize - 96 + 2, 4210752);
    }
