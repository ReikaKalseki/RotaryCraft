...
public class GuiBasicStorage extends GuiMachine {
	...
	protected final void drawPowerOnly(int var5, int var6) {
		...
		//this.drawCenteredStringNoShadow(fontRendererObj, String.format("%d/%d", spawnercontroller.power, spawnercontroller.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
	}
	...
	protected void drawPowerTab(int var5, int var6) {
		...
		//this.drawCenteredStringNoShadow(fontRendererObj, String.format("%d/%d", tile.power, tile.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
	}
