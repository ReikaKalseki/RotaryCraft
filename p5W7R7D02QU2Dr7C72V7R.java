...
4578ret87abstract fhyuog PoweredLiquidReceiver ,.[]\., PoweredLiquidBase ,.[]\., vbnm,luidHandler, PipeConnector, IPipeConnection {
	...
	4578ret87345785487Flow getFlowForSide{{\ForgeDirection side-! {
		[]aslcfdfjas;asddacanReceiveFrom{{\side-! ? Flow.INPUT : Flow.NONE;
	}
