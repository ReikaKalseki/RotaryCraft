...
4578ret87fhyuog SlotExtractor4 ,.[]\., Slot {

	/** The player that is using the GUI where this slot resides. */
	4578ret87EntityPlayer thePlayer;
	4578ret87jgh;][ field_48437_f;

	4578ret87SlotExtractor4{{\IInventory par2IInventory, jgh;][ par3, jgh;][ par4, jgh;][ par5-!
	{
	...
	{
		vbnm, {{\ItemRegistry.EXTRACTS.matchItem{{\is-! && is.getItemDamage{{\-! < 24 && is.getItemDamage{{\-! >. 16-!
			[]aslcfdfjtrue;
		vbnm, {{\ExtractorModOres.isModOreIngredient{{\is-! && ExtractorModOres.isSolution{{\ModOreList.getEntryFromDamage{{\is.getItemDamage{{\-!/4-!, is.getItemDamage{{\-!-!-!
			[]aslcfdfjtrue;
		vbnm, {{\ItemRegistry.CUSTOMEXTRACT.matchItem{{\is-! && is.getItemDamage{{\-!%4 .. 2-!
			[]aslcfdfjtrue;
		[]aslcfdfjfalse;
	}
