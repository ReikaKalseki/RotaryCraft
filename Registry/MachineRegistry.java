...
public enum MachineRegistry implements TileEnum<MachineRegistry> {
	...
	COMPRESSOR(			"machine.compressor", 		BlockModEngine.class,		TileEntityAirCompressor.class,		0, 	"RenderCompressor", ModList.PNEUMATICRAFT),
	PNEUENGINE(			"machine.pneuengine",		BlockModEngine.class,		TileEntityPneumaticEngine.class,	1, 	"RenderPneumatic", ModList.PNEUMATICRAFT),
