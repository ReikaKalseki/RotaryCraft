...
public enum MachineRegistry {
	...
	BYPASS(				"Bypass Pipe",				BlockPiping.class,			TileEntityBypass.class,				5, "PipeRenderer"),
	SEPARATION(			"Separation Pipe",			BlockPiping.class,			TileEntitySeparatorPipe.class,		6, "PipeRenderer");
