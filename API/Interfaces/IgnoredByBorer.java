 ...
 * negative hardness).<br>Note that if your block ius a liquid block, fluid handling code takes over and implementing
...
public interface IgnoredByBorer {
	 ...
	 * will still drop upon block destruction, or the block itself will drop on a silk-touch-enchanted Borer (unless isAir()
	 * returns true, the block is a liquid, or the block has a TileEntity).<br>
