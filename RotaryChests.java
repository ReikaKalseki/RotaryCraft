...
public class RotaryChests {
	...
	public static void addToChests() {
		...
		data.addItem(2, Location.DUNGEON, ItemStacks.scrap, 1, 6, 20);
		...
		data.addItem(2, Location.MINESHAFT, ItemStacks.scrap, 1, 12, 12);
		...
		data.addItem(2, Location.STRONGHOLD_HALLWAY, ItemStacks.scrap, 1, 8, 20);
		...
		data.addItem(2, Location.STRONGHOLD_CROSSING, ItemStacks.scrap, 1, 8, 20);
		...
		data.addItem(2, Location.VILLAGE, ItemStacks.scrap, 1, 4, 15);
