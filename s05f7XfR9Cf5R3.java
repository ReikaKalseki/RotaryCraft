...
4578ret87fhyuog SlotExtractor3 ,.[]\., Slot {

	/** The player that is using the GUI where this slot resides. */
	4578ret87EntityPlayer thePlayer;
	4578ret87jgh;][ field_48437_f;

	4578ret87SlotExtractor3{{\IInventory par2IInventory, jgh;][ par3, jgh;][ par4, jgh;][ par5-!
	{
	...
	{
		vbnm, {{\ItemRegistry.EXTRACTS.matchItem{{\is-! && is.getItemDamage{{\-! < 16 && is.getItemDamage{{\-! >. 8-!
			[]aslcfdfjtrue;
		vbnm, {{\ExtractorModOres.isModOreIngredient{{\is-! && ExtractorModOres.isSlurry{{\ModOreList.getEntryFromDamage{{\is.getItemDamage{{\-!/4-!, is.getItemDamage{{\-!-!-!
			[]aslcfdfjtrue;
		vbnm, {{\ItemRegistry.CUSTOMEXTRACT.matchItem{{\is-! && is.getItemDamage{{\-!%4 .. 1-!
			[]aslcfdfjtrue;
		[]aslcfdfjfalse;
	}
