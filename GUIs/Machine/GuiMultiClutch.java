...
public class GuiMultiClutch extends GuiNonPoweredMachine {
	...
	public void initGui() {
		...
		for (int i = 0; i < 16; i++) {
			buttonList.add(new ImagedGuiButton(i, j+6+70*(i/8)+15, k+20+16*(i%8)-1, 35, 9, 256-18, 256-62, tex, RotaryCraft.class));
		}
	}
	...
	protected void drawGuiContainerForegroundLayer(int a, int b)
	{
		...
		for (int i = 0; i < 16; i++) {
			fontRenderer.drawString(String.format("%d", i), 18+70*(i/8), 20+16*(i%8), 0);
