 ...
 ******************************************************************************/
package Reika.RotaryCraft.Renders.SixSided;
...
public class RenderSonicBorer extends RotaryTERenderer
{
	 ...
	 */
	public void renderTileEntitySonicBorerAt(TileEntitySonicBorer tile, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		this.bindTextureByName("/Reika/RotaryCraft/Textures/TileEntityTex/sonicborertex.png");
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((RotaryCraftTileEntity)tile))
			this.renderTileEntitySonicBorerAt((TileEntitySonicBorer)tile, par2, par4, par6, par8);
