...
public class RenderLawnSprinkler extends RotaryTERenderer
{
	 ...
	 */
	public void renderTileEntityLawnSprinklerAt(TileEntityLawnSprinkler tile, double par2, double par4, double par6, float par8)
	{
		ModelLawnSprinkler var14;
		var14 = LawnSprinklerModel;

		this.bindTextureByName("/Reika/RotaryCraft/Textures/TileEntityTex/lawnsprinklertex.png");
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((RotaryCraftTileEntity)tile))
			this.renderTileEntityLawnSprinklerAt((TileEntityLawnSprinkler)tile, par2, par4, par6, par8);
	}
