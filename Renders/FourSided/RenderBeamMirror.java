 ...
 ******************************************************************************/
package Reika.RotaryCraft.Renders.FourSided;
...
public class RenderBeamMirror extends RotaryTERenderer {
	 ...
	 */
	public void renderTileEntityBeamMirrorAt(TileEntityBeamMirror tile, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		this.bindTextureByName("/Reika/RotaryCraft/Textures/TileEntityTex/beammirrortex.png");
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((RotaryCraftTileEntity)tile))
			this.renderTileEntityBeamMirrorAt((TileEntityBeamMirror)tile, par2, par4, par6, par8);
