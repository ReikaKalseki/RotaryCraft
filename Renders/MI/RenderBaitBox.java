...
public class RenderBaitBox extends RotaryTERenderer
{
	 ...
	 */
	public void renderTileEntityBaitBoxAt(TileEntityBaitBox tile, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		else
		{
			...
			{
				//((BlockBaitBoxBlock1)var10).unifyAdjacentChests(tile.worldObj, tile.xCoord, tile.yCoord, tile.zCoord);
				var9 = tile.getBlockMetadata();
			}
		}
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((RotaryCraftTileEntity)tile))
			this.renderTileEntityBaitBoxAt((TileEntityBaitBox)tile, par2, par4, par6, par8);
