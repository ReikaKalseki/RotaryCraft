...
import Reika.RotaryCraft.Models.ModelAggregator;
...
public class RenderAggregator extends RotaryTERenderer
{
	 ...
	 */
	public void renderTileEntityAggregatorAt(TileEntityAggregator tile, double par2, double par4, double par6, float par8)
	{
		ModelAggregator var14;
		var14 = AggregatorModel;

		this.bindTextureByName("/Reika/RotaryCraft/Textures/TileEntityTex/aggregatortex.png");
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((RotaryCraftTileEntity)tile))
			this.renderTileEntityAggregatorAt((TileEntityAggregator)tile, par2, par4, par6, par8);
	...
	private void renderWater(TileEntityAggregator tile, double par2, double par4, double par6) {
