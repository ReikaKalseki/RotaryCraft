...
public class RenderFraction extends RotaryTERenderer
{
    ...
    public void renderTileEntityFractionatorAt(TileEntityFractionator tile, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            {
                //((BlockFractionBlock1)var10).unifyAdjacentChests(tile.worldObj, tile.xCoord, tile.yCoord, tile.zCoord);
                var9 = tile.getBlockMetadata();
            }
        }
        ...
        {
            ModelFraction var14;
            var14 = this.FractionModel;
            //ModelFractionV var15;
            //var14 = this.FractionModelV;
